...
in
{
  ...
  xdg.configFile = {
    "nvim/lazyvim.json".source = jsonFormat.generate "lazyvim.json" {
      extras = [ ];
      install_version = 8;
      news = { "NEWS.md" = "11866"; };
      version = 8;
    ...
    "nvim/lazy-lock.json".source = jsonFormat.generate "lazy-lock.json" {
    ...
    "nvim/.neoconf.json".source = jsonFormat.generate ".neoconf.json" {
      neodev.library = {
        enabled = true;
        plugins = true;
      };
    ...
    "nvim/stylua.toml".source = tomlFormat.generate "stylua.toml" {
      indent_type = "Spaces";
      indent_width = 2;
      column_width = 120;
    };
